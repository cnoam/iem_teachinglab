...
[2026-09-17 ] This doc version was written for Classic Clusters. compare it to the ../dbr-admin/Preparing*
...
Data for the course is stored in Azure storage account containers.

In the future, we will use DBR Unity Catalog. Until then, either mount the container(s) using SAS token, or use spark config with SAS to directly access the container without mounting.
